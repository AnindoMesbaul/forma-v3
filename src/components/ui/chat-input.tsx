  ...
  return (
    <ChatInputContext.Provider value={contextValue}>
      <div
        className={cn(
          variant === "default" &&
            "flex flex-col items-end w-full p-2 border border-border rounded-2xl bg-surface focus-within:ring-1 focus-within:ring-ring focus-within:border-ring",
  ...
  return (
    <Textarea
      ...
      className={cn(
        ...
        variant === "unstyled" &&
          "border-none bg-transparent shadow-none focus-visible:ring-0 focus-visible:ring-offset-0 px-1.5 py-1",
        className,
      )}
      rows={rows}
    />
  ...
  if (loading && onStop) {
    return (
      <Button
        onClick={onStop}
        size="icon"
        className={cn("shrink-0 rounded-full h-8 w-8", className)}
        {...props}
      >
        <svg
